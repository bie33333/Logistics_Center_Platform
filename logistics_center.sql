...
CREATE TABLE `order` (
  ...
  `good_num` int NOT NULL COMMENT '订单物品数量',
...
INSERT INTO `order` VALUES ('ORDER01','zhaoliu','赵六','44444444444','GOOD001',5,'电饭煲','CAR001','车辆1','张三','13572304567','陕西省西安市临潼区','暂无描述',1,20.61);
